...
| `experiments/self_eval_qa_lab/` | Mini repo self-evaluating QA lab v0.3: workflow router, full trace, ChatGPT baseline, critical audit, evolution proposals, ledger. |
