...
## Main Handoff
- Implementation spec: `workspace\factory_runs\20260610_201138_software_factory\10_implementation_spec.md`
...
## Next Command
```powershell
python run_company_agents_demo.py --real --task-file workspace\factory_runs\20260610_201138_software_factory\10_implementation_spec.md --real-max-steps 260
```
